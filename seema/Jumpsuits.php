...
<script>
// Your JavaScript code for filtering and sorting (same as in the HTML file)
document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchProducts(filters) {
        ...
        const mockProducts = [
            { id: 12, name: 'Playsuits', price: 39, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'j1.jpg' },
            { id: 13, name: 'Cedar Jumpsuit', price: 65, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'j2.jpg' },
            { id: 14, name: 'Floral Jumpsuit', price: 31, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'j3.jpg' },
            { id: 15, name: 'Boiler jumpsuits', price: 82, manufacturer: 'Repetitive manufacturing', style: 'Artsy fashion', wash: 'HAND WASH', image: 'j4.jpg' },
            { id: 16, name: 'Flared Jumpsuit', price: 91, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'j5.jpg' },
            { id: 17, name: 'Overall Jumpsuit', price: 93, manufacturer: 'Repetitive manufacturing', style: 'Artsy fashion', wash: 'HAND WASH', image: 'j6.jpg' },
        ];
        ...
        if (filters.sortOrder === 'Oldest First') {
            filteredProducts.sort((a, b) => a.id - b.id); // Assuming product ID is incremental based on date
        ...
        filteredProducts = filteredProducts.slice(0, filters.showCount); // Show limited products based on selected count
    ...
    fetchProducts(currentFilters); // Initial fetch on page load
});
