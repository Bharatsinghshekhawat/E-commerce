        ...
        <div class="col-md-3">
            <div class="filter-section">
                ...
                <ul class="list-unstyled">
                    ...
                    <!-- <li><a href="Newarrival.html" class="link-secondary">New Arrival</a></li>
                    <li><a href="all.html" class="link-secondary">Trousers-Shorts</a></li> -->
                </ul>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchProducts(filters) {
        const mockProducts = [
            { id: 1, name: 'Wool Blazer', price: 59, manufacturer: 'Repetitive manufacturing', style: 'Artsy fashion', wash: 'HAND WASH', image: 'mo1.jpg', dateAdded: '2022-06-01' },
            { id: 2, name: 'Blackberry Blazer', price: 65, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'mo2.jpg', dateAdded: '2023-01-10' },
            { id: 3, name: 'Printed Blazer', price: 36, manufacturer: 'Repetitive manufacturing', style: 'Artsy fashion', wash: 'HAND WASH', image: 'mo3.jpg', dateAdded: '2022-12-05' },
            { id: 4, name: 'Corduroy Blazer', price: 85, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'mo4.jpg', dateAdded: '2023-04-15' },
            { id: 5, name: 'Beige Blazer', price: 98, manufacturer: 'Batch process manufacturing', style: 'Classic fashion', wash: 'MACHINE WASH', image: 'mo5.jpg', dateAdded: '2023-07-22' }
        ];
